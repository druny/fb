                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('admin.store') }}"  enctype="multipart/form-data">
                            ...
                            <div class="form-group{{ $errors->has('short') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea id="short" type="text" class="form-control" name="short" value="{{ old('short') }}" required></textarea>
                                    @if ($errors->has('short'))
                                        <span class="help-block">
                                        <strong>
                                        {{ $errors->first('short') }}
                            ...
                            <div class="form-group{{ $errors->has('text') ? ' has-error' : '' }}">
                                ...
                                <div class="col-md-6">
                                    <textarea id="create-text"  type="text" class="form-control" name="text" value="{{ old('text') }}" ></textarea>
                                    @if ($errors->has('text'))
                                        <span class="help-block">
                                            <strong>
                                                {{ $errors->first('text') }}
